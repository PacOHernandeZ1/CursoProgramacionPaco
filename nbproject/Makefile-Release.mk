...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/funcion_para_romanos_y_nif

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/funcion_para_romanos_y_nif: ${OBJECTFILES}
...
${OBJECTDIR}/Comprobacion_Numero.o: Comprobacion_Numero.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Comprobacion_Numero.o Comprobacion_Numero.c
...
${OBJECTDIR}/validacionNumero.o: validacionNumero.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/validacionNumero.o validacionNumero.c
